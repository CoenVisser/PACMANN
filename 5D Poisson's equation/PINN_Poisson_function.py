...
def PINN_Poisson(train_number, 
                 ...
                 number_collocation_points_input = 750,
    ...
    if collocation_type == "Uniform":
        data = dde.data.PDE(
            geom, pde, bc, number_collocation_points, 750, solution=solution_function, num_test=10000, train_distribution="uniform"
            )
    elif collocation_type == "RAR" or collocation_type == "RAR_D":
        data = dde.data.PDE(
            geom, pde, bc, number_collocation_points // 2, 750, solution=solution_function, num_test=10000
            )
    else:
        data = dde.data.PDE(
            geom, pde, bc, number_collocation_points, 750, solution=solution_function, num_test=10000
            )
