...
def PINN_Navier_Stokes(train_number, 
                       ...
                       number_collocation_points_input = 700,
    ...
    output = [collocation_type, train_time, C1_L2, C2_L2, C1_final, C2_final, learning_rate, stepsize, number_collocation_points, random_seed, resample_period, number_of_iterations]
